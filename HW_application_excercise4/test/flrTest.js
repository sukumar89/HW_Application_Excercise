...
describe(`Tests for CME API for the test input  start time : ${data.startTime} ,end time : ${data.endTime}`, function () {
    ...
    it('Verify that starttimestamps and endtimestamps from the FLR response are within the date range given by the user' , function () {
        var timestamp = [];
        var sortedYes;
       body.map(X=>timestamp.push(X.beginTime));
